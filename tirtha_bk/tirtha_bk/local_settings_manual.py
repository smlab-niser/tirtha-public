...
PROD_DIR = "/home/faiz/TirthaProject/tirtha-public/tirtha_bk/temp_storage/prod/"  # Short term storage for current runs # CHANGEME:
NFS_DIR = "/home/faiz/TirthaProject/tirtha-public/tirtha_bk/temp_storage/archive/"  # Long term storage for old runs # CHANGEME: Does not need to use NFS and can be on the same system
...
DEFAULT_MESH_NAME = (
    "Sample"  # Default mesh name to use while setting up | Will be shown on homepage
)
DEFAULT_MESH_ID = "toudwNB7HJqgJeGF"
