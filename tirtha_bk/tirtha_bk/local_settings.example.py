...
# Static files
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static'),] # JS, CSS, images, favicon
STATIC_URL = '/static/'
...
NSFW_MODEL_DIRPATH = BASE_DIR / "nn_models/nsfw_model/mobilenet_v2_140_224/" # NOTE: See `Requirements` section in README.md
...
MESHOPS_CONTRIB_DELAY = 1 # hour(s) - time to wait before running meshops after a new contribution

## ARK settings
BASE_URL = "<your_base_url>" # CHANGEME: NOTE: No trailing '/' | e.g., https://tirtha.niser.ac.in (Use your own)
ARK_NAAN = <your_ark_naan> # CHANGEME: Integer
