...
class Mesh(models.Model):
    ...
    ID = ShortUUIDField(primary_key=True, length=16, max_length=16, verbose_name="Mesh ID")

    # Metadata
    name = models.CharField(max_length=200, blank=False)
    description = models.TextField(blank=True, verbose_name="Description", default="Placeholder Text")
    ...
    preview = models.ImageField(upload_to=set_preview, blank=False, verbose_name="Mesh Preview")
    thumbnail = models.ImageField(upload_to=set_thumbnail, blank=False, verbose_name="Mesh Thumbnail")
    ...
    status = models.CharField(max_length=50, blank=False, choices=status_options, default="Pending")
    ...
    reconstructed_at = models.DateTimeField('Last reconstructed at', blank=True, null=True)
    ...
    def save(self, *args, **kwargs):
        self.verbose_id = (self.country + "__" + self.state + "__" + self.district + "__" + self.name).replace(" ", "_")
...
class Contributor(models.Model):
    ID = models.UUIDField(primary_key=True, default=uuid.uuid4, verbose_name="Contributor ID")
...
class Contribution(models.Model):
    ID = models.UUIDField(primary_key=True, default=uuid.uuid4, verbose_name="Contribution ID")
    mesh = models.ForeignKey(Mesh, on_delete=models.CASCADE, verbose_name="Mesh ID", related_name="contributions")
    contributor = models.ForeignKey(Contributor, on_delete=models.CASCADE, verbose_name="Contributor ID", related_name="contributions")
...
class Image(models.Model):
    ...
    contribution = models.ForeignKey(Contribution, on_delete=models.CASCADE, related_name="images")
...
class ARK(models.Model):
    ...
    shoulder = models.CharField(max_length=10, blank=False, verbose_name="NAAN Shoulder")
    assigned_name = models.CharField(max_length=100, blank=False, verbose_name="Assigned Name")
    created_at = models.DateTimeField('Created at', auto_now_add=True)

    # Bound content - blank=False forces us to maintain metadata
    url = models.URLField(blank=False, verbose_name="Bound URL") # NOTE: This is the URL of the bound content (.glb)
    metadata = models.JSONField(blank=False, verbose_name="Metadata") # CHECK: if this can be used as API meanwhile FIXME: LATE_EXP:
...
class Run(models.Model):
    ID = ShortUUIDField(primary_key=True, length=16, max_length=16, verbose_name="Run ID")
    mesh = models.ForeignKey(Mesh, on_delete=models.CASCADE, verbose_name="Mesh ID", related_name="runs")
    ...
    directory = models.CharField(max_length=200, blank=True, verbose_name="Run directory")
    ...
    status = models.CharField(max_length=50, blank=False, choices=status_options, default="Processing")

    # Metadata
    contributors = models.ManyToManyField(Contributor, verbose_name="Contributors", related_name="runs")
    ...
    rotaX = models.IntegerField(default=0, null=True, verbose_name="Rotation about X-axis")
    rotaY = models.IntegerField(default=0, null=True, verbose_name="Rotation about Y-axis")
    rotaZ = models.IntegerField(default=0, null=True, verbose_name="Rotation about Z-axis")
