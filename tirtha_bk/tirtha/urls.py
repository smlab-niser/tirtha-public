...
urlpatterns = [
    path('howto/', views.howto, name='howto'),  # NOTE: Order matters
    ...
    re_path(r"^(resolve/)?(?P<ark>ark:/?.*$)", views.resolveARK, name="resolveARK"), # LATE_EXP: Add support for `?info` and `??info` queries or something similar. Check ARK spec.
